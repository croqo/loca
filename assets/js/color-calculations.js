 ...
 * @return {Object} - this
 */
function _locaChipsColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_locaChipsColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_locaChipsColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_locaChipsColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _locaChipsColor object.
 *
 * @since Loca Chips 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function locaChipsColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _locaChipsColor( backgroundColor, accentHue );

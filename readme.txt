...
Loca Chips WordPress Theme, Copyright 2019-2020 WordPress.org
Loca Chips is distributed under the terms of the GNU GPL.
...
Loca Chips is derived from the Chaplin Theme, Copyright 2019 Anders Norén
Chaplin Theme is distributed under the terms of the GNU GPL version 2.0

Loca Chips bundles the following third-party resources:
...
Bespoke Icons Created For Loca Chips
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
- LocaChips_SVG_Icons
- locachips_the_theme_svg()
- locachips_get_theme_svg()
- locachips_nav_menu_social_icons()
